...
public class Main {
    ...
    private static void addInitialData() {
        Task t1 = new Task(1, "Design architecture", LocalDate.parse("2025-07-01 12:00"));
        t1.addTag("project");
        t1.addTag("architecture");
        taskManager.addTask(t1);

        Task t2 = new Task(2, "Implement core system", LocalDate.parse("2025-07-15 13:00"));
        t2.addTag("project");
        t2.addTag("development");
        taskManager.addTask(t2);

        Task t3 = new Task(3, "Write tests", LocalDate.parse("2025-07-20 14:00"));
        t3.addTag("project");
        t3.addTag("qa");
        taskManager.addTask(t3);

        Task t4 = new Task(4, "Prepare documentation", LocalDate.parse("2025-07-18 15:00"));
        t4.addTag("documentation");
        t4.addTag("ga");
        taskManager.addTask(t4);

        Task t5 = new Task(10, "Requirements analysis", LocalDate.parse("2025-06-25 12:00"));
        t5.addTag("project");
        t5.addTag("analysis");
